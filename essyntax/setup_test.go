...
//		t.Fatal("Error in CreateIndex", err)
	...
	idx(`{"name": "Kevin Lowe",     "jersey": 4,  "pos": "D",  "goals": 4,
			...
			"quote": "Killer instinct is putting teams away and not making mistakes."}`)
